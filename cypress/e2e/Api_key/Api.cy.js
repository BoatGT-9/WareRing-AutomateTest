...
describe("Api-key", () => {
  ...
  it("TC10.002 Admin can export JSON file", () => {
    login("AdminWareringCaxknsa", "kmsad9ASdjas0LSJWd9iaa");
    cy.get("#toggle-nav-links-dialog-btn").click();
    cy.contains("API Keys").click();
    cy.get("#create-api-key-btn").click();
  ...
  it("TC10.003 Admin can Delete key", () => {
    login("AdminWareringCaxknsa", "kmsad9ASdjas0LSJWd9iaa");
    cy.get("#toggle-nav-links-dialog-btn").click();
    cy.contains("API Keys").click();
  ...
  it("TC10.004 Admin can't Create API KEY no have name  ",()=>{
    login("AdminWareringCaxknsa", "kmsad9ASdjas0LSJWd9iaa");
    cy.get("#toggle-nav-links-dialog-btn").click();
    cy.contains("API Keys").click();
    cy.get("#create-api-key-btn").click();
  ...
  it("TC10.005 Admin can't Create API KEY no have description ",()=>{
    login("AdminWareringCaxknsa", "kmsad9ASdjas0LSJWd9iaa");
    cy.get("#toggle-nav-links-dialog-btn").click();
    cy.contains("API Keys").click();
    cy.get("#create-api-key-btn").click();
  ...
  it("TC10.006 Admin can search Api key",()=>{
    login("AdminWareringCaxknsa", "kmsad9ASdjas0LSJWd9iaa");
    cy.get("#toggle-nav-links-dialog-btn").click();
    cy.contains("API Keys").click();
  ...
  it("TC10.007 Admin can filter Sort by Date Oldest",()=>{
    login("AdminWareringCaxknsa", "kmsad9ASdjas0LSJWd9iaa");
    cy.get("#toggle-nav-links-dialog-btn").click();
    cy.contains("API Keys").click();
  ...
  it("TC10.008 Admin can filter Sort by Date latest",()=>{
    login("AdminWareringCaxknsa", "kmsad9ASdjas0LSJWd9iaa");
    cy.get("#toggle-nav-links-dialog-btn").click();
    cy.contains("API Keys").click();
